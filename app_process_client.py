...
class App_Process_UI(Canvas):
     def __init__(self, parent, client):    
        ...
        self.button_1 = Button(self, text = 'PROCESS', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_2 = Button(self, text = 'KILL', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
            #image=button_image_2,
            borderwidth=0,
            highlightthickness=0,
        ...
        self.button_3 = Button(self, text = 'LIST', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_4 = Button(self, text = 'CLEAR', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_5 = Button(self, text = 'START', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_6 = Button(self, text = 'BACK', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
