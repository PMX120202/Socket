...
class Keylogger_UI(Canvas):
     def __init__(self, parent, client):    
        ...
        self.button_2 = Button(self, text = 'HOOK', width = 20, height = 5, fg = 'white', bg = '#ffd966',
        ...
        self.button_3 = Button(self, text = 'PRINT', width = 20, height = 5, fg = 'white', bg = '#ffd966',
        ...
        self.button_4 = Button(self, text = 'DELETE', width = 20, height = 5, fg = 'white', bg = '#ffd966',
        ...
        self.button_5 = Button(self, text = 'LOCK', width = 20, height = 5, fg = 'white', bg = '#ffd966',
        ...
        self.button_6 = Button(self, text = 'BACK', width = 20, height = 5, fg = 'white', bg = '#f44336',
