...
class DirectoryTree_UI(Canvas):
    def __init__(self, parent, client):
        ...
        self.button_2 = Button(self, text = 'SHOW', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_3 = Button(self, text = 'SEND FILE TO FOLDER', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_4 = Button(self, text = 'COPY THIS FILE', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
        ...
        self.button_5 = Button(self, text = 'DELETE', width = 20, height = 5, fg = 'white', bg = '#6fa8dc',
